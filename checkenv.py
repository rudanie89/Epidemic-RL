...
model = PPO("MlpPolicy", env,learning_rate=0.00001,batch_size=32,n_epochs=50,gamma=0.6,
            tensorboard_log=logdir,verbose=1) #,device='cuda' ##tensorboard_log=True,
