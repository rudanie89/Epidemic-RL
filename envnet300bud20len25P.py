...
G = nx.generators.random_graphs.binomial_graph(300,0.02,seed=247,directed=False) #seed=246,
#LFR_benchmark_graph(300, 3, 1.5, 0.5, average_degree=5.5, min_community=20, seed=246)
...
# Save bias belief
# pathbeliefMis = "D:\\project4\\codefirsttry\\synthetic\\outputjunebi\\net300\\belief\\beliefMis.txt"  # debunker10_14au
# pathbeliefMis = "D:\\project4\\codefirsttry\\syntheticpaper4\\output\\net1000bud20len25epi10k\\belief\\beliefMis.txt"
pathbeliefMis = "D:\\project4\\codefirsttry\\synthetic\\outputjunebi\\net300\\belief\\beliefMis.txt"
#
# with open(pathbeliefMis, 'w+') as fbeliefMis:
#     json.dump(beliefMis, fbeliefMis, indent=4)

# pathbeliefDe = "D:\\project4\\codefirsttry\\synthetic\\outputjunebi\\net300\\belief\\beliefDe.txt"  # debunker10_14au
# pathbeliefDe = "D:\\project4\\codefirsttry\\syntheticpaper4\\output\\net1000bud20len25epi10k\\belief\\beliefDe.txt"
pathbeliefDe = "D:\\project4\\codefirsttry\\synthetic\\outputjunebi\\net300\\belief\\beliefDe.txt"
...
for i in G.nodes:
    ...
    proindegreeDict[str(i)] = round(1/(len(indegreeDict[str(i)])+0.001),6) #0.1 #round(1/(len(indegreeDict[str(i)])+0.001),6)
